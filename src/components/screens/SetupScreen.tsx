                            ...
                            .map((item, index) => {
                                return <ListGroup.Item
                                    ...
                                    <div className="ms-2 me-auto w-100">
                                        <div className="level-title">{availableLevels.length - index} . {item.levelConfiguration.levelName}</div>
                                    ...
                                    {process.env.NODE_ENV === 'development' &&
                                        <Badge bg="primary" pill style={{ position: 'absolute', right: '10px', bottom: '10px' }}>
                    ...
                    <Row className="setup-screen-buttons g-0">
                        ...
                        <Col xs={6} className="ps-2">
                            <Button
                                ...
                                className="setup-screen-button"
                                onClick={() => props.onStartButton(availableLevels[selectedLevelIndex].levelConfiguration)}>
